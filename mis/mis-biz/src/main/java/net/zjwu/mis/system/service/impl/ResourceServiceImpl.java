...
import net.zjwu.mis.system.service.ResourceService;
...
public class ResourceServiceImpl extends BaseServiceImpl<Resource> implements
	...
	/*
	 * (non-Javadoc)
	 * @see net.zjwu.mis.service.impl.BaseServiceImpl#save(java.lang.Object)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see net.zjwu.mis.service.impl.BaseServiceImpl#update(java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.zjwu.mis.system.service.ResourceService#listResources()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.zjwu.mis.system.service.ResourceService#getResourcesByPidAndType(
	 * net.zjwu.mis.system.model.Resource)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.zjwu.mis.system.service.ResourceService#getResourcesByRoleId(java
	 * .lang.Integer)
	 */
	@Override
